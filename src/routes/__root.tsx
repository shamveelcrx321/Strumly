...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Search songs, explore chords, and turn lyrics into music with Strumly." },
      { name: "author", content: "Strumly" },
      { property: "og:title", content: "Strumly — Songs, Chords & Guitar" },
      { property: "og:description", content: "Search songs, explore chords, and turn lyrics into music with Strumly." },
